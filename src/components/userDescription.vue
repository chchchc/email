<template>
  <div>
    <el-row>
      <el-col :span="16">
        <div class="header-div1">应用说明</div>
      </el-col>
    </el-row>
  ...
  2.为不同贺卡类型上传模板
  3.保存模板"></el-step>
  <el-step title="确认发送规则" description="1.进入发送规则页
  2.设置相关贺卡发送参数
  3.保存"></el-step>
  <el-step title="启用模板" description="1.为不同的类型启用一个模板
  2.注意：一个类型仅有一个模板生效
  3.完成配置"></el-step>
</el-steps>

<el-button style="margin-top: 12px; align:left" icon="el-icon-right" @click="next">下一步</el-button>
  </div>
